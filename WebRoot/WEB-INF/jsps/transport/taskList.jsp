			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>发货方式:</td>
						<td>
							<s:select name="oqm.sm.needs" list="@com.swu.erp.invoice.supplier.vo.SupplierModel@needsMap" headerKey="-1" headerValue="---请-选-择---" cssStyle="width:115px"></s:select>
						</td>
						<td>审核人:</td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="orderList">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>${sm.needsView}</td> 
							<td>
							<s:if test="type==@com.swu.erp.invoice.order.vo.OrderModel@ORDER_TYPE_OF_BUY_CHECK_PASS">
