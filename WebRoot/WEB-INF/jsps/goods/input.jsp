...
<script type="text/javascript">
	$(function() {
		//为id="supplier"的标签绑定change事件
		$("#supplier").change(function() {
			//以post方式向后台发送ajax异步请求
			//参数一：请求的URL
			//参数二：当前请求所床底的参数
			//参数三：请求完成后执行的内容（回调）
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      <s:select id="supplier" name="gm.gtm.sm.uuid" list="supplierList" listKey="uuid" listValue="name"/>
				      </td>
				      <td width="18%"align="center">商品类别</td>
				      <td width="32%">
				      		 <s:select id="goodsType" name="gm.gtm.uuid" list="gtmList" listKey="uuid" listValue="name"/>
					  </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
