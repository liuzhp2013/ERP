				...
				<div style="border:1px solid #cecece;">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr bgcolor="#FFFFFF">
							...
							<td width="32%"><s:textfield name="em.userName" size="25" />
							</td>
							<td width="18%" align="center">真实姓名</td>
							<td width="32%"><s:textfield name="em.name" size="25" /></td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							...
							<td><s:textfield name="em.pwd" size="25" /></td>
							<td align="center">确认密码</td>
							<td><s:textfield size="25" /></td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							...
							<td><s:textfield name="em.email" size="25" />
							<td align="center">电话号码</td>
							<td><s:textfield name="em.tele" size="25" /></td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							...
							<td><s:select name="em.gender"
									list="@com.swu.erp.auth.emp.vo.EmpModel@genderMap"
									cssStyle="width:190px"></s:select>
							</td>
							<td align="center">地&nbsp;&nbsp;&nbsp;&nbsp;址</td>
							<td><s:textfield name="em.address" size="25" /></td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							...
							<td>
								<input type="text" size="25"
									...
									value="${em.birthdayView}" /> <s:hidden name="em.birthday" />
							</td>
							<td align="center">所属部门</td>
							<td>
								<s:select name="em.dm.uuid" list="depList"
									listKey="uuid" listValue="name" cssStyle="width:190px"></s:select>
							</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
