			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>
							<s:textfield name="eqm.userName" size="14"/>
						</td>
						<td>真实姓名</td>
						...
						<td>性&nbsp;&nbsp;&nbsp;&nbsp;别</td>
						<td>
						<s:select name="eqm.gender" list="@com.swu.erp.auth.emp.vo.EmpModel@genderMap" headerKey="-1" headerValue="----请-选-择----" cssClass="kuan"/>
						</td>
					...
					<tr>
						...
						<td>登录时间</td>
						<td>
							<input type="text"  size="14" onfocus="c.showMoreDay=false;c.show(this);" readonly="true" value="${eqm.lastLoginTimeView}"/>
							<s:hidden name="eqm.lastLoginTime"/>
						</td>
						<td>登录时间</td>
						<td>
							<input type="text" size="14" onfocus="c.showMoreDay=false;c.show(this);" readonly="true" value="${eqm.lastLoginTime2View}"/>
				...
				<s:iterator value="empList">
					<tr align="center" bgcolor="#FFFFFF">
						...
						<td>
							...
							<span style="line-height:12px; text-align:center;"> 
								<a href="javascript:void(0)" class="xiu" onclick="showMsg('是否删除该项数据？',${uuid})">
									删除
								</a>
							</span>
						</td>
