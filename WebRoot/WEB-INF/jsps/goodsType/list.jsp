			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="62">供应商:</td>
						<td width="142">
							<s:select  name="gqm.sm.uuid" list="supplierList"
							cssClass="kuan" headerKey="-1" headerValue="----请-选-择----" listKey="uuid" listValue="name"/>
						</td>
						<td width="60">类别名称:</td>
						<td width="149"><s:textfield name="gqm.name" size="18"/></td>
