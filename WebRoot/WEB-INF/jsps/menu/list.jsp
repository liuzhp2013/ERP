			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="62">菜单名称</td>
						<td width="142">
							<s:textfield name="mqm.name" size="18" />
						</td>
						<td width="60">所属菜单</td>
						<td width="149">
							<s:select list="parentList" name="mqm.parent.uuid" cssClass="kuan" listKey="uuid" listValue="name" headerKey="-1" headerValue="----请-选-择----"/>
						</td>
						<td width="70">
							<a id="query"> <img src="images/can_b_01.gif" border="0" /> </a>
						</td>
